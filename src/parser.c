...
enum ts_symbol_identifiers {
  ...
  sym_listitem = 96,
  sym_bullet = 97,
  aux_sym__multiline_text = 98,
  sym_expr = 99,
  aux_sym_document_repeat1 = 100,
  aux_sym__body_contents_repeat1 = 101,
  aux_sym__body_contents_repeat2 = 102,
  aux_sym_signature_repeat1 = 103,
  aux_sym_title_repeat1 = 104,
  aux_sym_list_repeat1 = 105,
  aux_sym_expr_repeat1 = 106,
};
...
static const TSLexerMode ts_lex_modes[STATE_COUNT] = {
  ...
  [11] = {.lex_state = 8, .external_lex_state = 7},
  ...
  [42] = {.lex_state = 8, .external_lex_state = 8},
  ...
  [65] = {.lex_state = 8, .external_lex_state = 6},
  ...
  [74] = {.lex_state = 8, .external_lex_state = 6},
  ...
  [93] = {.lex_state = 10, .external_lex_state = 8},
  [94] = {.lex_state = 14},
  ...
  [108] = {.lex_state = 10, .external_lex_state = 11},
  [109] = {.lex_state = 10, .external_lex_state = 10},
  ...
  [114] = {.lex_state = 10, .external_lex_state = 9},
  [115] = {.lex_state = 15},
  [116] = {.lex_state = 10, .external_lex_state = 10},
  [117] = {.lex_state = 10, .external_lex_state = 12},
  [118] = {.lex_state = 10, .external_lex_state = 10},
  [119] = {.lex_state = 10, .external_lex_state = 12},
  [120] = {.lex_state = 10, .external_lex_state = 9},
  [121] = {.lex_state = 10, .external_lex_state = 13},
  [122] = {.lex_state = 14},
  [123] = {.lex_state = 0, .external_lex_state = 10},
  [124] = {.lex_state = 0, .external_lex_state = 9},
  [125] = {.lex_state = 10, .external_lex_state = 13},
  [126] = {.lex_state = 10, .external_lex_state = 13},
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_listitem, 4, 0, 13),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_listitem, 5, 0, 14),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0), SHIFT_REPEAT(2),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0), SHIFT_REPEAT(98),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0),
  [83] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0), SHIFT_REPEAT(100),
  [86] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0), SHIFT_REPEAT(103),
  [89] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0), SHIFT_REPEAT(107),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paragraph, 1, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_paragraph, 1, 0, 0),
  ...
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat2, 2, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [107] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 3, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat2, 3, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat1, 2, 0, 0),
  [115] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat1, 2, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, SHIFT(57),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__body_contents_repeat2, 1, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat2, 1, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [130] = {.entry = {.count = 1, .reusable = false}}, SHIFT(45),
  [132] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  ...
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_title, 1, 0, 0),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title, 1, 0, 0),
  ...
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_heading, 3, 0, 9),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_heading, 3, 0, 9),
  [162] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_title_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_title_repeat1, 2, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_title_repeat1, 2, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = false}}, SHIFT(65),
  [171] = {.entry = {.count = 1, .reusable = false}}, SHIFT(68),
  [173] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__body_contents_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  ...
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 1, 0, 3),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multis, 1, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 2, 0, 4),
  [204] = {.entry = {.count = 1, .reusable = true}}, SHIFT(128),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 6), SHIFT_REPEAT(155),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 6),
  ...
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 1, 0, 1),
  ...
  [229] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_signature_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [232] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2, 0, 0), SHIFT_REPEAT(133),
  [235] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 3, 0, 0),
  ...
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2, 0, 0),
  [250] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_listitem, 6, 0, 15),
  [254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(152),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 3, 0, 0),
  [258] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_segment, 2, 0, 0),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 1, 0, 2),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 4, 0, 10),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 2, 0, 5),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 3, 0, 7),
  ...
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 3, 0, 8),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_listitem, 4, 0, 12),
  ...
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_segment, 2, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bullet, 2, 0, 0),
...
enum ts_external_scanner_symbol_identifiers {
  ...
  ts_external_token__two_spaces = 4,
